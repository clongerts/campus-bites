...
export default function WhereToDine() {
  ...
  const stalls: Stall[] = [
    ...
    { id: 23, name: "Day Off", loc: "Gonzaga", rating: 4, price: "₱100-150", tags: ["Gonzaga 1/F","Cafe"], image: "/images/Gonzaga/dayoff.png", menuImage: "/images/Gonzaga/menus/dayoffmenu.jpg", expectationImage: "/images/Gonzaga/dayoff.png", realityImage: "/images/reality/dayoff-real.jpg", isBestValue: false, menu: [{ name: "Biscoff Cookie Cloud", price: 120 }, { name: "Matcha Wave", price: 130 }], reviews: [{ id: "g6", user: "CaffeineFiend", rating: 4, comment: "Solid cold brew to get through Theo.", isAnonymous: true, date: "2026-05-10" }] },
    { id: 24, name: "Get Bowld", loc: "Gonzaga", rating: 4, price: "₱150-200", tags: ["Gonzaga 2/F",], image: "/images/Gonzaga/getbowld.png", menuImage: "/images/Gonzaga/menus/getbowldmenu.jpg", expectationImage: "/images/Gonzaga/getbowld.png", realityImage: "/images/reality/getbowld-real.jpg", isBestValue: false, menu: [{ name: "After Surf", price: 190 }, { name: "Chunky Monkey", price: 185 }], reviews: [{ id: "g7", user: "RiceBowlFan", rating: 4, comment: "Very filling and the beef is tender.", isAnonymous: false, date: "2026-05-03" }] },
    { id: 25, name: "Ghe!", loc: "Gonzaga", rating: 5, price: "₱100-150", tags: ["Gonzaga 1/F", "Budget"], image: "/images/Gonzaga/ghe.png", menuImage: "/images/Gonzaga/menus/ghemenu.jpg", expectationImage: "/images/Gonzaga/ghe.png", realityImage: "/images/reality/ghe-real.jpg", isBestValue: true, menu: [{ name: "Beef Fries", price: 100 }, { name: "Chicken Wrap", price: 150 }, { name: "Lukumades", price: 105 }], reviews: [{ id: "g8", user: "LolaVibes", rating: 5, comment: "Tastes like home. Adobo is top notch.", isAnonymous: false, date: "2026-04-30" }] },
    ...
    { id: 30, name: "Tomo", loc: "Gonzaga", rating: 5, price: "₱150-200", tags: ["Gonzaga 1/F","Cafe"], image: "/images/Gonzaga/tomo.png", menuImage: "/images/Gonzaga/menus/tomomenu.jpg", expectationImage: "/images/Gonzaga/tomo.png", realityImage: "/images/reality/tomo-real.jpg", isBestValue: false, menu: [{ name: "Sushi Roll", price: 150 }, { name: "Ramen", price: 220 }], reviews: [{ id: "g13", user: "SushiMaster", rating: 5, comment: "The ramen broth is surprisingly rich.", isAnonymous: false, date: "2026-05-07" }] },
    ...
    { id: 32, name: "Good Taste", loc: "Gonzaga", rating: 5, price: "₱100-150", tags: ["Gonzaga 1/F","Asian"], image: "/images/Gonzaga/goodtaste.png", menuImage: "/images/Gonzaga/menus/goodtastemenu.jpg", expectationImage: "/images/Gonzaga/goodtaste.png", realityImage: "/images/reality/goodtastereak.jpg", isBestValue: true, menu: [{ name: "Happy Chickie", price: 120 }, { name: "Goodie Fish", price: 130 }], reviews: [{ id: "g13", user: "SushiMaster", rating: 5, comment: "The ramen broth is surprisingly rich.", isAnonymous: false, date: "2026-05-07" }] },
    { id: 24, name: "Blue Cafe", loc: "Gonzaga", rating: 4, price: "₱150-200", tags: ["Gonzaga 2/F",], image: "/images/Gonzaga/bluecafe.png", menuImage: "/images/Gonzaga/menus/bluecafe.jpg", expectationImage: "/images/Gonzaga/bluecafe.png", realityImage: "/images/reality/bluecafe-real.jpg", isBestValue: false, menu: [{ name: "Latte", price: 190 }, { name: "Cold Brew", price: 185 }], reviews: [{ id: "g7", user: "RiceBowlFan", rating: 4, comment: "Very filling and the beef is tender.", isAnonymous: false, date: "2026-05-03" }] },
